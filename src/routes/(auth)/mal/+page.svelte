...
<div>
   <div>
      <div class="flex flex-col md:flex-row gap-3 md:justify-between">
         <div class="text-xl md:text-3xl">Keuangan</div>
      </div>
...
<Modal width="max-w-lg" bind:show={form_bayar_modal} title="Form Pembayaran">
   <form on:submit|preventDefault={savePayment} class="p-4 space-y-4">
      ...
      <div class="space-y-1">
         ...
         <div>
            {(iltizamat+tabarruat+tabloid+buletin+majalah).toLocaleString("id")}
         </div>
      </div>
      <button
         type="submit"
