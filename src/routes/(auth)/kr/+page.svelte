...
dayjs.locale("id"); 
    ...
    let editkrModal = false;
 
    function savekr() {
       active_kr.peserta = active_kr.list_peserta.length;
       active_kr.bulan = dayjs(active_kr.tanggal).format("MMMM YYYY");
       active_kr.id = dayjs(active_kr.tanggal).format("YYYY-MM-DD-")+generateRandomString(5);
 ...
 <Modal width="max-w-lg" bind:show={editkrModal} title="Edit kr">
    <form on:submit|preventDefault={savekr} class="p-4 space-y-4">
       <div class="space-y-1">
